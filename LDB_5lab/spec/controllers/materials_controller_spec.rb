...
describe MaterialsController do
  ...
  it 'covers mutation -if key' do
    expect { post :addprov, params: { } }.not_to raise_error(ActionController::ParameterMissing)
  end

  it 'covers mutation -if key, on offers' do
    expect { post :addof, params: { } }.not_to raise_error(ActionController::ParameterMissing)
  end
  ...
  it 'actually creates offer' do
    post :addof, params: { :material => { :name => 'naujas', :material => 'Cars', :unit => 20, :ppu => 1500 } }
    prov = ProvidedMaterial.find_by(name: 'naujas', material: 'Cars', unit: 20, ppu: '1500')
