...
ActiveRecord::Schema.define(version: 2018_11_07_194654) do
  ...
  create_table "notes_managers", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "work_group_managers", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
